<?php /* Smarty version Smarty-3.1.16, created on 2015-10-06 06:19:18
         compiled from "tpl\application\make_rule.html" */ ?>
<?php /*%%SmartyHeaderCode:2174561337014f46d5-21626526%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '34c4cfd9bf84a35be06c7cc165dd5c0b4a6188f1' => 
    array (
      0 => 'tpl\\application\\make_rule.html',
      1 => 1444105150,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2174561337014f46d5-21626526',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_561337016712a1_94902125',
  'variables' => 
  array (
    'appinfo' => 0,
    'keywords' => 0,
...
<?php if ($_valid && !is_callable('content_561337016712a1_94902125')) {function content_561337016712a1_94902125($_smarty_tpl) {?><div  style="overflow-y:hidden" class="tab-pane fade in active" id="home">
  ...
  <div id="makeRule" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
      <p> <strong> 应用名:<?php echo (($tmp = @$_smarty_tpl->tpl_vars['appinfo']->value['appname'])===null||$tmp==='' ? '' : $tmp);?>
</strong> &nbsp;&nbsp; 是否生效:
...
?>
                          <tr>
                            <td onclick=clickaction(this)><?php echo (($tmp = @$_smarty_tpl->tpl_vars['value']->value['key'])===null||$tmp==='' ? '' : $tmp);?>
</td>
                          </tr>
                          <?php } ?>
                        </tbody>
    ...
    <div class="modal-footer">
      ...
      <input type="hidden" name="appid" value="<?php echo $_smarty_tpl->tpl_vars['appinfo']->value['id'];?>
">
